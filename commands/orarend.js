...
exports.run = async (client, message, args) => {
    ...
    const lastday = new Date(curr.setDate(curr.getDate()+6)).toISOString().split("T")[0];
    
    const data = await getApiData(`${commonEndpoints.timetable}?datumTol=${firstday}&datumIg=${lastday}`,datas)
